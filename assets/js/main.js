...
function renderProfile() {
  ...
  const gradeText   = gradeLabels[parseInt(app.userGrade)] || (app.userGrade ? `الفرقة ${app.userGrade}` : '—');
  const dept        = app.userDept || 'رياضيات وعلوم الحاسب';
  ...
  const avatarCard = `
    <div class="profile-card">
      ...
      <p class="profile-dept">${escHtml(dept)} · كلية العلوم</p>
    </div>`;
  ...
  if (role === 'student') {
    rows = `
      <div class="info-row"><span class="info-lbl">الكود الجامعي</span><span class="info-val">${escHtml(app.userCode)}</span></div>
      <div class="info-row"><span class="info-lbl">الاسم الكامل</span><span class="info-val">${escHtml(app.userName)}</span></div>
      <div class="info-row"><span class="info-lbl">الفرقة</span><span class="info-val">${gradeText}</span></div>
      <div class="info-row"><span class="info-lbl">القسم</span><span class="info-val">${escHtml(dept)}</span></div>
      ...
      <div class="info-row"><span class="info-lbl">الدور</span><span class="info-val">${escHtml(app.roleLabel || 'طالب')}</span></div>`;

  } else if (role === 'doctor') {
    rows = `
      <div class="info-row"><span class="info-lbl">الاسم الكامل</span><span class="info-val">${escHtml(app.userName)}</span></div>
      <div class="info-row"><span class="info-lbl">الإيميل الجامعي</span><span class="info-val">${escHtml(app.userEmail) || '—'}</span></div>
      <div class="info-row"><span class="info-lbl">الدرجة العلمية</span><span class="info-val">${escHtml(app.userDegree) || '—'}</span></div>
      <div class="info-row"><span class="info-lbl">سنة الالتحاق</span><span class="info-val">${escHtml(app.userJoinYear) || '—'}</span></div>
      <div class="info-row"><span class="info-lbl">الخبرة</span><span class="info-val">${escHtml(app.userExp) || '—'}</span></div>`;
    ...
    rows = `
      <div class="info-row"><span class="info-lbl">الكود الجامعي</span><span class="info-val">${escHtml(app.userCode)}</span></div>
      <div class="info-row"><span class="info-lbl">الاسم الكامل</span><span class="info-val">${escHtml(app.userName)}</span></div>
      <div class="info-row"><span class="info-lbl">الإيميل الشخصي</span><span class="info-val">${escHtml(app.userEmail) || '—'}</span></div>
      <div class="info-row"><span class="info-lbl">الفرقة</span><span class="info-val">${gradeText}</span></div>
      <div class="info-row"><span class="info-lbl">القسم</span><span class="info-val">${escHtml(dept)}</span></div>`;
  }
  ...
  const infoCard = `
    <div class="profile-info-card">
      <h4 class="info-title">البيانات الأكاديمية</h4>
